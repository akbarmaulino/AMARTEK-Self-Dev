...
for (int i = 0; i < filteredRows.size(); i++) {
	String userEmployeeName = filteredRows[i].findElement(By.xpath(".//div[@role='cell'][4]//div")).getText()
	KeywordUtil.logInfo("Hasil Search - Baris ke-${i + 1}:UserRole=${userEmployeeName}")
}
