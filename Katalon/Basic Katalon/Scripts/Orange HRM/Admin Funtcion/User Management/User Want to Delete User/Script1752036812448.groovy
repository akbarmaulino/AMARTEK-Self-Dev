...
WebUI.click(findTestObject('Object Repository/Orange HRM/Admin Menu/User Management/button_Add'))
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Orange HRM/Admin Menu/User Management/row_Table'), 10)
...
WebUI.click(findTestObject('Object Repository/Orange HRM/Admin Menu/User Management/button_Confrim Delete'))

if (WebUI.verifyElementPresent(findTestObject('Object Repository/Orange HRM/Admin Menu/User Management/alert_Success Delete'), 10)) {
    KeywordUtil.logInfo('Pesan Berhasil untuk Hapus User Berhasil')

    String successDelete = WebUI.getText(findTestObject('Object Repository/Orange HRM/Admin Menu/User Management/alert_Success Delete'))
    ...
    WebUI.setText(findTestObject('Object Repository/Orange HRM/Admin Menu/User Management/field_Search Username'), GlobalVariable.addUsername)
