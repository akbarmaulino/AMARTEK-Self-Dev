...
WebUI.click(findTestObject('Object Repository/Orange HRM/Admin Menu/Job Title/Main Page/button_Add'))

WebUI.setText(findTestObject('Object Repository/Orange HRM/Admin Menu/Job Title/Main Page/field_Job Title'), GlobalVariable.JobTitle)

WebUI.setText(findTestObject('Object Repository/Orange HRM/Admin Menu/Job Title/Main Page/field_Job Description'), GlobalVariable.JobDescription)

WebUI.uploadFile(findTestObject('Orange HRM/Admin Menu/Job Title/Main Page/form_Upload'), GlobalVariable.pathUploadFile)

WebUI.setText(findTestObject('Object Repository/Orange HRM/Admin Menu/Job Title/Main Page/field_Note'), GlobalVariable.JobNote)
